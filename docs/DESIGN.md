---
title: Amrit Palace - Style Reference
aliases:
  - Amrit Palace
  - Style Reference
tags:
...
> [!question] Unconfirmed for this project
> This palette does not match [[app-demo.html]], which uses an orange/paper "Gradion" token set. Confirm which system the real UI follows before building screens, and record the call in [[DECISIONS]].

> [!quote] spiced parchment gallery — a candlelit beige wall holding sparse saffron punctuation beneath breath-soft serif headlines.
...
:root {
  ...
  --font-tt-ramillas-variable:
    "TT Ramillas Variable", ui-sans-serif, system-ui, -apple-system,
...
- [[Index]] - vault hub
- [[PRD]] - assessment brief; UI requirements live in §4.4
- [[DECISIONS]] - where the design-system call gets recorded
